...
%% correctly.
%\begin{acronym}[DCT-III] % longest acronym in these square brackets
%\acro{NPS}{Naval Postgraduate School}
%\acro{DCT-III}{discrete Cosine Transform}
%\acro{DSFT}{discrete spatial Fourier transform}
%\acro{DTT}{discrete Triangle Transform}
%\acro{FFT}{fast Fourier transform}
%\acro{FFT2}{two-dimensional fast Fourier transform}
%\acrodefplural{FFT2}{two-dimensional FFTs}
%\end{acronym}
