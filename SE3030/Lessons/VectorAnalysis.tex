...
\frame{{Triple Products (continued)}
    \begin{exampleblock}{6.3.2}
        \begin{align*}
            \text{given: } \vec{B} &= 2\hat{i}-\hat{j}+3\hat{k} &\text{(force)} \\
            \vec{C} &= \hat{j}-5\hat{k} &\text{(displacement)} \\
            \text{apply: } W &= F\cdot d \\
            \text{find: }
...
\frame{{Expressions Involving $\nabla$ (continued)}
    \begin{exampleblock}{6.7.5 (Div)}
        \begin{align*}
            \text{given: }\vec{V} &= x^2\hat{i}+y^2\hat{j}+z^2\hat{k} \\
            \text{find: }\nabla\cdot\vec{V} &= 
            \dfrac{\partial V_x}{\partial x} +
            \dfrac{\partial V_y}{\partial y} +
            \dfrac{\partial V_z}{\partial z} \\
...
\frame{{Expressions Involving $\nabla$ (continued)}
    \begin{exampleblock}{6.7.5 (Curl)}
        \begin{align*}
            \text{given: }\vec{V} &= x^2\hat{i}+y^2\hat{j}+z^2\hat{k} \\
            \text{find: }\nabla\times\vec{V} &= 
                                \left(\dfrac{\partial V_z}{\partial y}-\dfrac{\partial V_x}{\partial z}\right)\hat{i} \\
                                &+ \left(\dfrac{\partial V_x}{\partial z}-\dfrac{\partial V_z}{\partial x}\right)\hat{j} \\
                                &+ \left(\dfrac{\partial V_y}{\partial x}-\dfrac{\partial V_x}{\partial y}\right)\hat{k} \\
...
\frame{{Line Integrals}
    \begin{center}
    \includegraphics[width=0.75\textwidth]{images/parabolic_curtain.png}
    \end{center}
}
