...
\frame{{Manual Approach}
  Mitchell describes a manual attempt that uses the \emph{local majority} to determine the state of any given cell.  While this sounds like it might be a reasonable approach, it fals to resolve boundaries.
  \begin{center}
    \incluegraphics[]{}
  \end{center}
