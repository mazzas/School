...
syn region unorderedEventBlock start=+{+ end=+}+ fold transparent contains=basicLanguageKeywords, montereyIteration, montereyVariable, montereyOperator
syn region orderedEventBlock start=+(+ end=+)+ fold transparent contains=basicLanguageKeywords, montereyIteration, montereyVariable, montereyOperator
syn region optionalElementBlock start=+\[+ end=+\]+ fold transparent contains=basicLanguageKeywords, montereyIteration, montereyVariable, montereyOperator
